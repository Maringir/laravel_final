...
<div class="card card-primary">
    ...
    <form action="{{ route('admin.travels.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="release-date">@langTitle('app.travel_date')</label>
                <input type="date" class="form-control" name="travel_date" id="travel_date" placeholder="@lang('app.travel_date')">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" max="1000" name="duration_days" id="duration_days" placeholder="@lang('app.duration_days')">
            </div>

            <div class="form-group">
                <label for="price_euro">@langTitle('app.price_euro')</label>
                <input type="text" class="form-control" maxlength="5" name="price_euro" id="price_euro" placeholder="@lang('app.price_euro')">
            </div>
            <x-forms.multi-relation-select :tagName="'extras'" :relationItems="$extras" />

            <x-forms.multi-relation-select :tagName="'languages'" :relationItems="$languages" />

            <x-forms.multi-relation-select :tagName="'destinations'" :relationItems="$destinations" />

            <x-forms.multi-relation-select :tagName="'tourists'" :relationItems="$tourists" :optionDisplay="'fullName'" />
