        ...
        <div class="card">
            <div class="card-header">
                ...
                <span class='header-actions'>
                    <a href="{{ route('admin.tourists.create') }} " class="btn btn-app new-resource">
                ...
                <table id="admin-table" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('admin.tourists.edit', $model) }}" type="button"
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a onclick="event.preventDefault()" class="dropdown-item delete"
                                            href="{{ route('admin.tourists.destroy', $model) }}">
